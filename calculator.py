...
# a conversion method from the user's input to float
...
while True:
    ...
    while True:
        ...
        if operator == "help":
            ...
            exit()
        # Has the user entered a valid operator?
    ...
    if not (
            operator == "/-" or operator == "!" or operator == "Abs" or operator == "d/r" or operator == "r/d" or operator == "M+" or operator == "sin" or operator == "cos" or operator == "tan" or operator == "asin" or operator == "acos" or operator == "atan" or operator == "log10"):
    ...
    #
    # floatNum1 = int(input("Enter first number: "))
    # floatNum2 = int(input("Enter second number: "))

    # if choice == '1':
    #     print(floatNum1, "+", floatNum2, "=", (floatNum1 + floatNum2))
    #
    # elif choice == '2':
    #     print(floatNum1, "-", floatNum2, "=", (floatNum1 - floatNum2))
    #
